          ...
          r.exports = function t(r, i, a) {
            ...
            function c(o) {
              ...
              function r(e) {
                ...
                return (
                  t ||
                    (t = n._loadingSchemas[r] = n._opts.loadSchema(r)).then(
                      a,
                      a
                    ),
                  t
        ...
        function (e, r, t) {
          ...
          r.exports = function c(e, u, h, r) {
            ...
            try {
              ...
              return (
                n &&
                  ...
                  (n.root = i.root),
                  (n.$async = i.$async),
                  p.sourceCode && (n.source = i.source)),
                i
              );
            } finally {
              q.call(this, e, u, r);
            ...
            function w(e, r, t, a) {
              ...
              (n = H(d, U) + H(v, N) + H(y, Q) + H(g, V) + n),
                p.processCode && (n = p.processCode(n));
              try {
                var l = new Function(
                  "self",
                  "RULES",
                ...
                throw (
                  (f.logger.error("Error compiling schema, function code:", n),
                  e)
                );
              }
              return (
                ...
                i && (o.$async = !0),
                !0 === p.sourceCode &&
                  (o.source = { code: n, patterns: v, defaults: y }),
                o
              );
            }
            function b(e, r, t) {
            ...
            function D(e, r, t, a) {
              if (!1 !== f._opts.validateSchema) {
                ...
                if (o) {
                  ...
                  if (!i) {
                    var n =
                      "keyword schema is invalid: " + f.errorsText(o.errors);
              ...
              if (c) l = c.call(f, r, t, a);
              else if (h)
                (l = h.call(f, r, t, a)),
                  !1 !== p.validateSchema && f.validateSchema(l, !0);
              else if (u) l = u.call(f, a, e.keyword, r, t);
              ...
              var d = g.length;
              return { code: "customRule" + d, validate: (g[d] = l) };
            }
          };
        },
        {
        ...
        function (e, r, t) {
          ...
          function c(e, r, t) {
            ...
            var s,
              ...
              n = u.call(this, r, t);
            return (
              n && ((s = n.schema), (r = n.root), (i = n.baseId)),
              s instanceof l
                  ...
                  if ("" !== r) {
                    ...
                    if (
                      (void 0 !== i &&
                        (c +=
                          "/" +
                          ("number" == typeof i ? i : y.escapeFragment(i))),
                      "string" == typeof n)
                    ) {
                      n = l = P(l ? m.resolve(l, n) : n);
                      var u = p._refs[n];
                      if (
                        ("string" == typeof u && (u = p._refs[u]),
                        u && u.schema)
                      ) {
                        if (!v(e, u.schema))
                          throw new Error(
          ...
          r.exports = function (e, r) {
            ...
            for (var E in ((t += "var missing" + a + ";"), m))
              if ((g = m[E]).length) {
                if (
                  ((t +=
                    " if ( " + c + e.util.getProperty(E) + " !== undefined "),
                  v &&
                    (t +=
        ...
        function (e, r, t) {
          ...
          r.exports = function (e, r) {
            ...
            var p = "valid" + d.level,
              ...
              g = e.baseId;
            if (
              ((t += "var " + h + " = errors;var " + u + ";"), Array.isArray(o))
            ) {
          ...
          r.exports = function (e, r) {
            ...
            if (
              ...
              (e.compositeRule = h.compositeRule = !0),
                (h.createErrors = !1),
                h.opts.allErrors &&
                  ((f = h.opts.allErrors), (h.opts.allErrors = !1)),
                (t += " " + e.validate(h) + " "),
                (h.createErrors = !0),
            ...
            if (
              ...
              if (
                ...
                if (((t += " var isAdditional" + a + " = !(false "), P.length))
                  if (8 < P.length)
                    t +=
                      " || validate.schema" + i + ".hasOwnProperty(" + p + ") ";
                  else {
                    var I = P;
                    if (I)
            ...
            if ("#" == i || "#/" == i)
              ...
              if (void 0 === h) {
                ...
                (p.schema = h.schema),
                  ...
                  (s +=
                    " " +
                    e.validate(p).replace(/validate\.schema/g, h.code) +
                    " "),
                  l && (s += " if (" + m + ") { ");
              } else
                (t = !0 === h.$async || (e.async && !1 !== h.$async)),
                  (a = h.code);
            }
            if (a) {
              var v;
          ...
          r.exports = function (a, e) {
            ...
            if (
              (a.isTop &&
                ...
                o &&
                  (a.opts.sourceCode || a.opts.processCode) &&
                  (r += " /*# sourceURL=" + o + " */ ")),
            ...
            if (a.isTop) {
              ...
              if ((o && (a.baseId = a.resolve.url(a.baseId, o)), t && !a.async))
            ...
            if (
              (a.schema.$comment &&
                a.opts.$comment &&
                (r += " " + a.RULES.all.$comment.code(a, "$comment")),
              w)
            ) {
                ...
                if (
                  ...
                  (r += " " + p + " = " + x + "; "),
                    ...
                    (r +=
                      ...
                      I +
                      "[" +
                      (c ? a.dataPathArr[c] : "parentDataProperty") +
                      "] = " +
                      x +
                      "; } ");
                } else {
                ...
                for (var C = -1, k = A.length - 1; C < k; )
                  if (G((_ = A[(C += 1)]))) {
                    if (
                      (_.type &&
                        (r +=
                          " if (" + a.util.checkDataType(_.type, p) + ") { "),
                      a.opts.useDefaults)
                    )
                    ...
                    var H = _.rules;
                    if (H)
                      for (var K, M = -1, B = H.length - 1; M < B; )
                        if (Y((K = H[(M += 1)]))) {
          ...
          r.exports = {
            ...
            validate: function e(r, t) {
              ...
              var a = (this._validateKeyword =
                this._validateKeyword || this.compile(s, !0));
              if (a(r)) return !0;
              e.errors = a.errors;
              {
                if (t)
        ...
        function (e, r, t) {
          ...
          r.exports = function e(r, t) {
            ...
            if (r && t && "object" == typeof r && "object" == typeof t) {
              ...
              if ((a = (o = Object.keys(r)).length) !== Object.keys(t).length)
                return !1;
              for (s = a; 0 != s--; )
          ...
          (a = this),
            (function (e) {
                ...
                return (
                  ...
                  void 0 !== e.userinfo &&
                    (e.userinfo = String(e.userinfo)
                      .replace(t.PCT_ENCODED, r)
                      .replace(t.NOT_USERINFO, m)
                      .replace(t.PCT_ENCODED, p)),
                  void 0 !== e.host &&
                    (e.host = String(e.host)
                      .replace(t.PCT_ENCODED, r)
                      .toLowerCase()
                      .replace(t.NOT_HOST, m)
                      .replace(t.PCT_ENCODED, p)),
                  void 0 !== e.path &&
                  ...
                  void 0 !== e.query &&
                    (e.query = String(e.query)
                      .replace(t.PCT_ENCODED, r)
                      .replace(t.NOT_QUERY, m)
                      .replace(t.PCT_ENCODED, p)),
                  void 0 !== e.fragment &&
                    (e.fragment = String(e.fragment)
                      .replace(t.PCT_ENCODED, r)
                      .replace(t.NOT_FRAGMENT, m)
                      .replace(t.PCT_ENCODED, p)),
                  e
                );
              }
              ...
              function j(r) {
                ...
                if (
                  ...
                  try {
                    r.host = t.iri
                      ? v.toUnicode(r.host)
                      : v.toASCII(
                          r.host.replace(e.PCT_ENCODED, f).toLowerCase()
                        );
                  } catch (e) {
                    r.error =
                      r.error ||
                ...
                return (
                  void 0 !== r.query && (a.push("?"), a.push(r.query)),
              ...
              function O(e, r) {
                var t =
                  ...
                  a = {};
                return (
                  arguments[3] || ((e = _(j(e, t), t)), (r = _(j(r, t), t))),
                    ...
                    : (void 0 !== r.userinfo ||
                      ...
                      void 0 !== r.port
                        ...
                        : (r.path
                            ...
                            : ((a.path = e.path),
                              (a.query =
                                void 0 !== r.query ? r.query : e.query)),
              ...
              function I(e, r) {
                return (
                  ...
                  e
                    .toString()
                    .replace(r && r.iri ? h.PCT_ENCODED : u.PCT_ENCODED, f)
                );
              }
              var N = {
                  scheme: "http",
              ...
              var ee = {
                ...
                te = {
                  ...
                  serialize: function (e, r) {
                    var t = e.nid,
                      a =
                        d[(r.scheme || e.scheme || "urn") + ":" + (r.nid || t)];
                    a && (e = a.serialize(e, r));
                    var s = e;
