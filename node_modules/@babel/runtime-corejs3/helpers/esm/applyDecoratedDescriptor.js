...
export default function _applyDecoratedDescriptor(
  ...
  _forEachInstanceProperty((_context = _Object$keys(descriptor))).call(
    _context,
    function (key) {
  ...
  desc = _reduceInstanceProperty(
    (_context2 = _reverseInstanceProperty(
      (_context3 = _sliceInstanceProperty(decorators).call(decorators))
    ).call(_context3))
  ).call(
    _context2,
