...
function _decorate(decorators, factory, superClass, mixins) {
  ...
  var decorated = api.decorateClass(
    _coalesceClassElements(
      _mapInstanceProperty((_context = r.d)).call(
        _context,
...
function _getDecoratorsApi() {
  ...
  var api = {
    ...
    initializeInstanceElements: function initializeInstanceElements(
      ...
      _forEachInstanceProperty((_context2 = ["method", "field"])).call(
        _context2,
        function (kind) {
          _forEachInstanceProperty(elements).call(
            elements,
            function (element) {
    ...
    initializeClassElements: function initializeClassElements(F, elements) {
      ...
      _forEachInstanceProperty((_context3 = ["method", "field"])).call(
        _context3,
        function (kind) {
          _forEachInstanceProperty(elements).call(
            elements,
    ...
    addElementPlacement: function addElementPlacement(
      ...
      if (
        !silent &&
        _indexOfInstanceProperty(keys).call(keys, element.key) !== -1
      ) {
    ...
    decorateElement: function decorateElement(element, placements) {
      ...
      for (
        ...
        _spliceInstanceProperty(keys).call(
          keys,
          _indexOfInstanceProperty(keys).call(keys, element.key),
          1
        );
    ...
    toElementDescriptors: function toElementDescriptors(elementObjects) {
      ...
      return _mapInstanceProperty((_context4 = toArray(elementObjects))).call(
        _context4,
    ...
    fromClassDescriptor: function fromClassDescriptor(elements) {
      var obj = {
        kind: "class",
        elements: _mapInstanceProperty(elements).call(
          elements,
...
function _coalesceClassElements(elements) {
  ...
  for (var i = 0; i < elements.length; i++) {
    ...
    if (
      element.kind === "method" &&
      (other = _findInstanceProperty(newElements).call(
        newElements,
        isSameElement
      ))
    ) {
