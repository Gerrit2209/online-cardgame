...
var _AlertDialogRole = _interopRequireDefault(
  require("./etc/objects/AlertDialogRole")
);

var _AlertRole = _interopRequireDefault(require("./etc/objects/AlertRole"));

var _AnnotationRole = _interopRequireDefault(
  require("./etc/objects/AnnotationRole")
);

var _ApplicationRole = _interopRequireDefault(
  require("./etc/objects/ApplicationRole")
);
...
var _BlockquoteRole = _interopRequireDefault(
  require("./etc/objects/BlockquoteRole")
);

var _BusyIndicatorRole = _interopRequireDefault(
  require("./etc/objects/BusyIndicatorRole")
);
...
var _CheckBoxRole = _interopRequireDefault(
  require("./etc/objects/CheckBoxRole")
);

var _ColorWellRole = _interopRequireDefault(
  require("./etc/objects/ColorWellRole")
);

var _ColumnHeaderRole = _interopRequireDefault(
  require("./etc/objects/ColumnHeaderRole")
);

var _ColumnRole = _interopRequireDefault(require("./etc/objects/ColumnRole"));

var _ComboBoxRole = _interopRequireDefault(
  require("./etc/objects/ComboBoxRole")
);

var _ComplementaryRole = _interopRequireDefault(
  require("./etc/objects/ComplementaryRole")
);

var _ContentInfoRole = _interopRequireDefault(
  require("./etc/objects/ContentInfoRole")
);

var _DateRole = _interopRequireDefault(require("./etc/objects/DateRole"));

var _DateTimeRole = _interopRequireDefault(
  require("./etc/objects/DateTimeRole")
);

var _DefinitionRole = _interopRequireDefault(
  require("./etc/objects/DefinitionRole")
);

var _DescriptionListDetailRole = _interopRequireDefault(
  require("./etc/objects/DescriptionListDetailRole")
);

var _DescriptionListRole = _interopRequireDefault(
  require("./etc/objects/DescriptionListRole")
);

var _DescriptionListTermRole = _interopRequireDefault(
  require("./etc/objects/DescriptionListTermRole")
);
...
var _DirectoryRole = _interopRequireDefault(
  require("./etc/objects/DirectoryRole")
);

var _DisclosureTriangleRole = _interopRequireDefault(
  require("./etc/objects/DisclosureTriangleRole")
);

var _DivRole = _interopRequireDefault(require("./etc/objects/DivRole"));

var _DocumentRole = _interopRequireDefault(
  require("./etc/objects/DocumentRole")
);

var _EmbeddedObjectRole = _interopRequireDefault(
  require("./etc/objects/EmbeddedObjectRole")
);

var _FeedRole = _interopRequireDefault(require("./etc/objects/FeedRole"));

var _FigcaptionRole = _interopRequireDefault(
  require("./etc/objects/FigcaptionRole")
);
...
var _IframePresentationalRole = _interopRequireDefault(
  require("./etc/objects/IframePresentationalRole")
);
...
var _ImageMapLinkRole = _interopRequireDefault(
  require("./etc/objects/ImageMapLinkRole")
);

var _ImageMapRole = _interopRequireDefault(
  require("./etc/objects/ImageMapRole")
);

var _ImageRole = _interopRequireDefault(require("./etc/objects/ImageRole"));

var _InlineTextBoxRole = _interopRequireDefault(
  require("./etc/objects/InlineTextBoxRole")
);

var _InputTimeRole = _interopRequireDefault(
  require("./etc/objects/InputTimeRole")
);
...
var _LineBreakRole = _interopRequireDefault(
  require("./etc/objects/LineBreakRole")
);

var _LinkRole = _interopRequireDefault(require("./etc/objects/LinkRole"));

var _ListBoxOptionRole = _interopRequireDefault(
  require("./etc/objects/ListBoxOptionRole")
);

var _ListBoxRole = _interopRequireDefault(require("./etc/objects/ListBoxRole"));

var _ListItemRole = _interopRequireDefault(
  require("./etc/objects/ListItemRole")
);

var _ListMarkerRole = _interopRequireDefault(
  require("./etc/objects/ListMarkerRole")
);
...
var _MenuButtonRole = _interopRequireDefault(
  require("./etc/objects/MenuButtonRole")
);

var _MenuItemRole = _interopRequireDefault(
  require("./etc/objects/MenuItemRole")
);

var _MenuItemCheckBoxRole = _interopRequireDefault(
  require("./etc/objects/MenuItemCheckBoxRole")
);

var _MenuItemRadioRole = _interopRequireDefault(
  require("./etc/objects/MenuItemRadioRole")
);

var _MenuListOptionRole = _interopRequireDefault(
  require("./etc/objects/MenuListOptionRole")
);

var _MenuListPopupRole = _interopRequireDefault(
  require("./etc/objects/MenuListPopupRole")
);
...
var _NavigationRole = _interopRequireDefault(
  require("./etc/objects/NavigationRole")
);
...
var _ParagraphRole = _interopRequireDefault(
  require("./etc/objects/ParagraphRole")
);

var _PopUpButtonRole = _interopRequireDefault(
  require("./etc/objects/PopUpButtonRole")
);

var _PreRole = _interopRequireDefault(require("./etc/objects/PreRole"));

var _PresentationalRole = _interopRequireDefault(
  require("./etc/objects/PresentationalRole")
);

var _ProgressIndicatorRole = _interopRequireDefault(
  require("./etc/objects/ProgressIndicatorRole")
);

var _RadioButtonRole = _interopRequireDefault(
  require("./etc/objects/RadioButtonRole")
);
...
var _RootWebAreaRole = _interopRequireDefault(
  require("./etc/objects/RootWebAreaRole")
);

var _RowHeaderRole = _interopRequireDefault(
  require("./etc/objects/RowHeaderRole")
);
...
var _ScrollAreaRole = _interopRequireDefault(
  require("./etc/objects/ScrollAreaRole")
);

var _ScrollBarRole = _interopRequireDefault(
  require("./etc/objects/ScrollBarRole")
);

var _SeamlessWebAreaRole = _interopRequireDefault(
  require("./etc/objects/SeamlessWebAreaRole")
);

var _SearchRole = _interopRequireDefault(require("./etc/objects/SearchRole"));

var _SearchBoxRole = _interopRequireDefault(
  require("./etc/objects/SearchBoxRole")
);

var _SliderRole = _interopRequireDefault(require("./etc/objects/SliderRole"));

var _SliderThumbRole = _interopRequireDefault(
  require("./etc/objects/SliderThumbRole")
);

var _SpinButtonRole = _interopRequireDefault(
  require("./etc/objects/SpinButtonRole")
);

var _SpinButtonPartRole = _interopRequireDefault(
  require("./etc/objects/SpinButtonPartRole")
);

var _SplitterRole = _interopRequireDefault(
  require("./etc/objects/SplitterRole")
);

var _StaticTextRole = _interopRequireDefault(
  require("./etc/objects/StaticTextRole")
);
...
var _TabGroupRole = _interopRequireDefault(
  require("./etc/objects/TabGroupRole")
);

var _TabRole = _interopRequireDefault(require("./etc/objects/TabRole"));

var _TableHeaderContainerRole = _interopRequireDefault(
  require("./etc/objects/TableHeaderContainerRole")
);
...
var _TabPanelRole = _interopRequireDefault(
  require("./etc/objects/TabPanelRole")
);

var _TermRole = _interopRequireDefault(require("./etc/objects/TermRole"));

var _TextFieldRole = _interopRequireDefault(
  require("./etc/objects/TextFieldRole")
);
...
var _ToggleButtonRole = _interopRequireDefault(
  require("./etc/objects/ToggleButtonRole")
);
...
var _TreeGridRole = _interopRequireDefault(
  require("./etc/objects/TreeGridRole")
);

var _TreeItemRole = _interopRequireDefault(
  require("./etc/objects/TreeItemRole")
);

var _UserInterfaceTooltipRole = _interopRequireDefault(
  require("./etc/objects/UserInterfaceTooltipRole")
);
