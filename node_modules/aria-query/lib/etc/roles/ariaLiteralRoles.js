...
var ariaLiteralRoles = new Map([
  ["alert", _alertRole2.default],
  ["alertdialog", _alertdialogRole2.default],
  ["application", _applicationRole2.default],
  ["article", _articleRole2.default],
  ["banner", _bannerRole2.default],
  ["button", _buttonRole2.default],
  ["cell", _cellRole2.default],
  ["checkbox", _checkboxRole2.default],
  ["columnheader", _columnheaderRole2.default],
  ["combobox", _comboboxRole2.default],
  ["complementary", _complementaryRole2.default],
  ["contentinfo", _contentinfoRole2.default],
  ["definition", _definitionRole2.default],
  ["dialog", _dialogRole2.default],
  ["directory", _directoryRole2.default],
  ["document", _documentRole2.default],
  ["feed", _feedRole2.default],
  ["figure", _figureRole2.default],
  ["form", _formRole2.default],
  ["grid", _gridRole2.default],
  ["gridcell", _gridcellRole2.default],
  ["group", _groupRole2.default],
  ["heading", _headingRole2.default],
  ["img", _imgRole2.default],
  ["link", _linkRole2.default],
  ["list", _listRole2.default],
  ["listbox", _listboxRole2.default],
  ["listitem", _listitemRole2.default],
  ["log", _logRole2.default],
  ["main", _mainRole2.default],
  ["marquee", _marqueeRole2.default],
  ["math", _mathRole2.default],
  ["menu", _menuRole2.default],
  ["menubar", _menubarRole2.default],
  ["menuitem", _menuitemRole2.default],
  ["menuitemcheckbox", _menuitemcheckboxRole2.default],
  ["menuitemradio", _menuitemradioRole2.default],
  ["navigation", _navigationRole2.default],
  ["none", _noneRole2.default],
  ["note", _noteRole2.default],
  ["option", _optionRole2.default],
  ["presentation", _presentationRole2.default],
  ["progressbar", _progressbarRole2.default],
  ["radio", _radioRole2.default],
  ["radiogroup", _radiogroupRole2.default],
  ["region", _regionRole2.default],
  ["row", _rowRole2.default],
  ["rowgroup", _rowgroupRole2.default],
  ["rowheader", _rowheaderRole2.default],
  ["scrollbar", _scrollbarRole2.default],
  ["search", _searchRole2.default],
  ["searchbox", _searchboxRole2.default],
  ["separator", _separatorRole2.default],
  ["slider", _sliderRole2.default],
  ["spinbutton", _spinbuttonRole2.default],
  ["status", _statusRole2.default],
  ["switch", _switchRole2.default],
  ["tab", _tabRole2.default],
  ["table", _tableRole2.default],
  ["tablist", _tablistRole2.default],
  ["tabpanel", _tabpanelRole2.default],
  ["term", _termRole2.default],
  ["textbox", _textboxRole2.default],
  ["timer", _timerRole2.default],
  ["toolbar", _toolbarRole2.default],
  ["tooltip", _tooltipRole2.default],
  ["tree", _treeRole2.default],
  ["treegrid", _treegridRole2.default],
  ["treeitem", _treeitemRole2.default],
]);
