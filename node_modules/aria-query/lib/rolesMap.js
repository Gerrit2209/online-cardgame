...
[
  _ariaAbstractRoles2.default,
  _ariaLiteralRoles2.default,
  _ariaDpubRoles2.default,
].forEach(function (roleSet) {
...
rolesMap.forEach(function (roleDefinition, name) {
  ...
  try {
    for (
      var _iterator = roleDefinition.superClass[Symbol.iterator](), _step;
      ...
      try {
        for (
          var _iterator2 = superClassIter[Symbol.iterator](), _step2;
          ...
          if (superClassDefinition) {
            ...
            try {
              for (
                var _iterator3 = Object.keys(superClassDefinition.props)[
                    Symbol.iterator
                  ](),
                  _step3;
                ...
                if (
                  ...
                  Object.assign(
                    roleDefinition.props,
                    _defineProperty({}, prop, superClassDefinition.props[prop])
                  );
                }
              }
            } catch (err) {
